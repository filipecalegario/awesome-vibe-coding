...
- [Kilo Code](https://kilocode.ai/) - Extensão de agente de codificação com IA de código aberto para IDEs populares como VS Code e JetBrains.
- [Amp](https://ampcode.com/) - Agente de codificação de ponta para seu terminal e editor, construído pela Sourcegraph.
...
- [Gemini CLI](https://github.com/google-gemini/gemini-cli) - Um agente de IA de código aberto do Google que leva o poder do Gemini diretamente para o seu terminal.
- [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) - "qwen-code é um agente de codificação que vive no mundo digital".
- [opencode](https://opencode.ai/) - "Agente de codificação com IA construído para o terminal".
- [charmbracelet/crush](https://github.com/charmbracelet/crush) - "O glamouroso agente de codificação com IA para seu terminal favorito", gera interfaces de linha de comando.
- [Warp](https://www.warp.dev/) - Uma linha de comando baseada em Rust com integração nativa de IA.
...
- 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) - Um quadro kanban para gerenciar e orquestrar agentes de codificação com IA.
