...
- [LoopTroop](https://github.com/looptroop-ai/LoopTroop) - Open-source local GUI for running long-running AI coding tickets with LLM council planning, isolated git worktrees, and Ralph retry loops.
