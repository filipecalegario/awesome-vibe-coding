...
- [Explyt](https://github.com/explyt/explyt) - AI agent for JetBrains IDEs. Uses IDE tools like the debugger, refactorings, and static analysis to handle complex or legacy vibe-coded projects.
