...
- [Forge](https://github.com/LucasDuys/forge) - Autonomous spec-driven development loop for Claude Code. Turns ideas into shipped code via brainstorm, plan, and execute commands with context survival and self-correcting backpropagation.
