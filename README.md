...
- [Launchproof](https://github.com/agentozzy/launchproof) - Evidence-first production-readiness checklist, audit template, and worked review for AI-assisted web apps.
