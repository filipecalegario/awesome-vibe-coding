...
- * [SpecVibe](https://github.com/badideal-2046/SpecVibe ) - A structured, executable framework that guides AI agents to build production-ready apps using a spec-driven methodology.
