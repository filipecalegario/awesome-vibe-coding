...
- [Kilo Code](https://kilocode.ai/) - 适用于VS Code和JetBrains等主流IDE的开源AI编程代理扩展。
- [Amp](https://ampcode.com/) - 由Sourcegraph构建的前沿编程代理，适用于终端和编辑器。
...
- [Gemini CLI](https://github.com/google-gemini/gemini-cli) - 谷歌开源的AI代理，将Gemini的强大功能直接带入您的终端。
- [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) - "qwen-code是一个生活在数字世界的编程代理"。
- [opencode](https://opencode.ai/) - "为终端构建的AI编程代理"。
- [charmbracelet/crush](https://github.com/charmbracelet/crush) - "为你最爱的终端打造的迷人AI编程代理"，生成命令行界面。
- [Warp](https://www.warp.dev/) - 基于Rust的命令行，具有原生AI集成。
...
- 🔥 [vibe-kanban](https://github.com/BloopAI/vibe-kanban) - 用于管理和编排AI编程代理的看板。
